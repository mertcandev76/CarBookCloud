...
namespace CarBookCloud.Domain.ValueObjects
{
    public class Address
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(street)) throw new ArgumentException("Adresin sokağı girilmesi zorunludur.");
            if (string.IsNullOrWhiteSpace(city)) throw new ArgumentException("Şehir alanı zorunludur.");
            Street = street;
            City = city;
